...
// import type { RegistryCategories, ComponentType } from '../../registry';
...
//     const ComponentToRender = getComponent(validCategoryId, componentId, activeTab);
...
const ComponentDetail: React.FC<ComponentDetailProps> = ({
  ...
  // Function to load the appropriate content based on the active tab
  const renderTabContent = () => {
    // Type assertion to convert categoryId to RegistryCategories
    // This tells TypeScript that we know this is a valid category
    const validCategoryId = categoryId as RegistryCategories;
