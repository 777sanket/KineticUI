  ...
  return (
    <div className="prose prose-sm">
      ...
      <ul className="list-disc pl-5 space-y-2">
        <li>
          <code className="bg-blue-300 px-1 py-0.5 rounded">
            fadeInDuration
          </code>
        ...
        <li>
          <code className="bg-blue-300 px-1 py-0.5 rounded">initialDelay</code>:
          Delay before the animation starts (in milliseconds). Default: 0ms
        </li>
        <li>
          <code className="bg-blue-300 px-1 py-0.5 rounded">repeat</code>:
      ...
      <ul className="list-disc pl-5 space-y-2">
        <li>
          <code className="bg-blue-300 px-1 py-0.5 rounded">className</code>:
      ...
      <pre className="bg-blue-300 p-2 rounded">
        {`<FadedText 
